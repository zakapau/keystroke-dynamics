...
void Obrabotka()  //Обучение программы на данных - метод логистической регрессии
{
	double lambda=0;
	int len=86;      //Количество параметров клавиатурного почерка
	int raz=50;     //Количество раз ввода
